...
int brighter(struct halide_buffer_t *_p1_buffer, uint8_t _p0, struct halide_buffer_t *_f0_buffer) HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return brighter_metadata;
}
#endif


int brighter_old_buffer_t(struct buffer_t *_p1, uint8_t _p0, struct buffer_t *_f0) HALIDE_FUNCTION_ATTRS;
